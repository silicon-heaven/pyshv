...
:meth:`shv.SHVMethods.method`. This is decorated that can be used only in
classes based on :class:`shv.SHVMethods`.

.. sourcecode::

   @SHVDevice.method("somePath", RpcMethodDesc.getter("custom", signal=True))
