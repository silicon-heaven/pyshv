...
class RpcMessage:
    ...
    class Type(enum.Enum):
        ...
        This is defined to allow message differenciate in ``match``. It doesn't
        fully correspond to the message types defined in SHV standard. Rather
        this is type based on the expected message handling.
        """
    ...
    def is_valid(self) -> bool:
        ...
        return (
            ...
            and len(self.value) <= 1  # Only one Key is allowed
