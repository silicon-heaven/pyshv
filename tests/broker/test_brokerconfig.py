...
@pytest.mark.parametrize(
    ...
    (
        ...
        (USER_TEST, ".broker", "clients", RpcMethodAccess.BROWSE),
        (USER_TEST, ".broker", "mounts", RpcMethodAccess.BROWSE),
        (USER_TEST, ".broker/currentClient", "subscribe", RpcMethodAccess.READ),
        (USER_TEST, ".broker/currentClient", "unsubscribe", RpcMethodAccess.READ),
        (
            USER_TEST,
        ...
        (USER_NOBODY, ".broker", "ls", RpcMethodAccess.BROWSE),
        (USER_NOBODY, ".broker/currentClient", "ls", RpcMethodAccess.READ),
    ),
)
